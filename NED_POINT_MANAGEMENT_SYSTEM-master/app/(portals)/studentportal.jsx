...
// Use router for navigating to different pages
...
const studentportal = () => {
  ...
  const handleLogin = () => {
    if (loggedInUser) {
      showAlert("Already Logged In", "A user is already logged in. Please logout first.");
      return;
    }
    ...
    fetch('http://localhost:3000/login', {
      ...
      .then(data => {
        if (data.success) {
          const loginSuccess = loginUser({ id: data.userId, role: 'student' });
          ...
          if (loginSuccess) {
            ...
            showAlert("Login Failed", "A user is already logged in.");
          }
        } else {
